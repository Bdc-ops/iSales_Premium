...
import Support_login_navbar from '../../navbars/support/support_login_navbar';
...
export default class Support_login extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    let log_msg1 = "\n" + moment().format('YYYY-MM-DD hh:mm:ss a') + " : Support Login\n-------";
              ...
              axios(
                ...
                .then(response => {
                  if (response.status === 200) {
                    ...
                    let log_msg2 = "\n" + moment().format('YYYY-MM-DD hh:mm:ss a') + " : Support Login: Ticket bien envoyer :" + response.status + "\n-------";
                ...
                .catch(error => {
                  this.setState({ response: 'Erreur technique, veuillez réessayer plus tard' })
                  console.log(error);
  ...
  render() {
    ...
    return (
      ...
      <ScrollView contentContainerStyle={styles.containerMain} >
        <Support_login_navbar title={navigate}></Support_login_navbar>
                    ...
                    <CardView cardElevation={10} cornerRadius={5} style={styles.cardViewStyle}>
                      ...
                      <View style={{ marginLeft: 20 }}>
                        ...
                        <TextInput style={styles.inputs} ref={input => { this.subject = input }}
                          returnKeyLabel={"next"} onChangeText={(text) => this.setState({ subject: text })} placeholder="Veuillez écrire un titre à votre problématique"></TextInput>
