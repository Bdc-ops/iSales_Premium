...
class Commandes_navbar extends React.Component {
  back() {
  ...
  sync_commandes() {
    ...
    Alert.alert(
      "IMPORTANT",
      "La synchronisation des commandes engendrera une suppression de votre base de données commandes locale pour télécharger une nouvelle",
      [
        { text: "Je confirme", onPress: () => this.props.title('SyncCommandes') },
        { text: "Annuler" }
      ],
      { cancelable: true }
    );
...
export default Commandes_navbar;