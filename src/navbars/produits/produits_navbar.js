...
class Produits_navbar extends React.Component {
  ...
  search_prod() {
    this.props.title('SearchProduits', { id_cat: this.props.subtitle });
  }
  go_panier() {
...
export default Produits_navbar;